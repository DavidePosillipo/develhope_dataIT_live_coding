...
1. ogni film della lista movies_id, fornisca il numero totale di attori
2. aggiungere un parametro che permetta di scegliere un film specifico. La funzione restituisce il numero totale di attori solo per il film scelto
